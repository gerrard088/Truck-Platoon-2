...
def generate_launch_description():
    ...
    runner = Node(
        ...
        executable='deterministic_scenario_runner',
        name='deterministic_scenario_runner',
        output='screen',
        additional_env={
            'DET_EXPERIMENT_TAG': experiment_tag,
        },
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('experiment_tag', default_value='deterministic_experiment'),
        bridge,
        runner,
    ])
